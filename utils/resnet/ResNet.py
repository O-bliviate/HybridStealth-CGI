...
class ResNet(torchvision.models.ResNet):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
                 ...
                 norm_layer=None, strides=[1, 2, 2, 2], pool='avg', no_init=False):
    ...
    def forward_with_feature(self, x: Tensor):
        x = self.conv1(x)
        x = self.bn1(x)
        x = self.relu(x)
...
def resnet20_4(num_classes=10, no_init=False):
    return ResNet(torchvision.models.resnet.BasicBlock, [3, 3, 3], num_classes=num_classes, base_width=16 * 4, no_init=no_init)


def resnet34(num_classes=10, no_init=False):
    return ResNet(torchvision.models.resnet.BasicBlock, [3, 4, 6, 3], num_classes=num_classes, base_width=64, no_init=no_init)
